...
namespace Application
{
    ...
    {
        private static readonly string ALL_SUBSEQUENT_LAYERS_PATTERN = "#";
        private static readonly string SUBSEQUENT_LAYER_PATTERN = "*";
        ...
        private void GetTopicNodes(Dictionary<string, ITopicNode> nodesMap, ITopicNode node, string[] patternKeys, int index)
        {
            ...
            if (string.Equals(ALL_SUBSEQUENT_LAYERS_PATTERN, key))
            {
            ...
            else if (string.Equals(SUBSEQUENT_LAYER_PATTERN, key))
            {
                if (isLastPatternKey)
