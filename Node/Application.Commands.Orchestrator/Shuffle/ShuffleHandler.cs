...
public sealed class ShuffleHandler : ICommandHandler<Shuffle>
{
    ...
    private readonly IMessagePublisher<Reduce> _publisher;

    private readonly IGroupAttributionService _groupAttributionService;

    private readonly ISyncStore<string, Group> _groupSyncStore;
